...
export default class trab1 { 
    #vencimento // Propriedade Privada

    constructor() { //Primeiro método a ser executado, é o construtor da classe
    ...
    consultarUltimoPagamento() { // Método
        return this.#vencimento.at(-1);
    }
